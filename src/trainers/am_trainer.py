...
class AMTrainer(SOCTrainer):
    ...
    def grad_inner_product(
        ...
        def inner_product(x):
            ...
            prev_sample_init, _, _, _, _ = self.soc_pipeline.scheduler.step(
                noise_pred, 
                None, 
                t, 
                x,
    ...
    def compute_loss(
        ...
        **kwargs,
        ...
        """
        prompt_embeds, negative_prompt_embeds, all_x_t, all_t, prompts = batch
    ...
    def generate_trajectories(self, prompts):
        _, _, _, trajectories, prompt_embeds, negative_prompt_embeds = self.soc_pipeline(
            prompts['text'],
        ...
        x_t = trajectories
        t = self.time_steps
        batch = prompt_embeds, negative_prompt_embeds, x_t, t, prompts
        return batch
